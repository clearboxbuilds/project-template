...
[![Instagram](https://img.shields.io/twitter/follow/clearboxbuilds?style=for-the-badge&logo=instagram&logoColor=%23FF0069&label=Instagram)
](https://www.instagram.com/clearboxbuilds)
...
* `ai/` - Files used when working with AI
  * [`plan-overview.md`](./ai/plan-overview.md) - The original, human-created plan.
  * [`plan.md`](./ai/plan.md) - The final plan built with AI.
  * [`plan-status.md`](./ai/plan-status.md) - The final plan status tracker used during development.
  * `transcripts/` - AI chat transcripts used in the project
...
- [Kirk](https://github.com/knation) via [Clearbox Builds](https://github.com/clearboxbuilds)
